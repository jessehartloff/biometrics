...
public class TestingSTMC extends Server{
...
//			testE.setHashes(template.getHashes());
			...
			testTE.add(testE);
			System.out.println("after : " + testE.getHashes());
		}
		
		
		Template FV = hasher.hashEnrollTemplate(enrollTE);
		ArrayList<Template> testers = hasher.hashTestTemplates(testTE);
		
		System.out.println(hasher.compareTemplates(FV, testers));
