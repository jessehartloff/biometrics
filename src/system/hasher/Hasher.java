...
/**
 * Controls all the hashing details. Typically, this class is in charge of the
...
public abstract class Hasher {
	...
	/**
	 * Converts a biometric to the test template(s). There could be more than
	 * one if the method is not invariant or has any other reason to have more
	 * than one. This may also differ from the enrolled template on the Hasher
	 * level also. Best example of this is fuzzy vault where the enrolled
	...
	/**
	 * Computes the matching score between an enrolled template and a set of
	 * test templates. Returns the score to best matching test template.
	 * 
	 * @param enrolledTemplate
	 * @param testTemplate
	 * @return Score of the best matching test template
	 */
	public abstract Double compareTemplates(Template enrolledTemplate,
	...
	/**
	 * Compares an enrolled template with a biometric without having to
	 * pre-compute the test templates.
	 * 
	 * @param enrolledTemplate
	 * @param biometric
	 * @return Matching score
	 */
	public Double compareTemplateWithBiometric(Template enrolledTemplate,
			Biometric biometric) {
