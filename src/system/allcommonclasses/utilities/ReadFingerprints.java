...
public class ReadFingerprints {
    ...
    public static AllUsers read2002DB1(){
...
//            System.out.println(filename + " is | user number: " + userNumber + " | reading number: " + readingNumber);
            ...
            try {
                ...
                while( (line = reader.readLine()) !=null){
                    ...
                    currentMinutia.setX(Integer.parseInt(values[0]));
                    currentMinutia.setY(Integer.parseInt(values[1]));
                    currentMinutia.setTheta(Integer.parseInt(values[2]));
                    currentMinutia.setQuality(Integer.parseInt(values[3]));
